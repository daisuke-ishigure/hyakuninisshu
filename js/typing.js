...
function showResults() {
  ...
  const RANKS = [
    { min: 300, label: "歌聖",   color: "#B82343", range: "300〜" },
    { min: 200, label: "六歌仙", color: "#b35f16", range: "200〜299" },
    { min: 100, label: "名人",   color: "#8a6d1c", range: "100〜199" },
    { min:  50, label: "歌詠み", color: "#4a7c59", range: "50〜99" },
    { min:   0, label: "手習い", color: "#5c6a7d", range: "〜49" },
  ];
