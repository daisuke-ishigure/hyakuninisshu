...
function createSelectionScreen() {
    ...
    <hr>
            <div class="title"><h1>百人一首 ビンゴゲーム</h1></div>
            <ul id="karuta_ul">
                <li>縦・横・斜めのいずれか1列揃えればクリアです。</li>
                <li>クリアするまでにかかった時間が表示されます。</li>
                <li>お手つきのたびに5秒のペナルティが加算されます。</li>
            </ul>
            <p class="kome" style="margin: 0.25em 0 0.75em 2em;"><small>音声:NHKクリエイティブ・ライブラリー</small></p>
    ...
    container.innerHTML = `
        <div class="section">
            <div class="question-box-compact" style="border-color:${borderColor};">
                <p style="font-size:0.8rem; color:#888; margin-bottom:5px;">この歌の下の句を探してね</p>
                <h3 id="current-kami" style="font-size:1.25rem; line-height:1.5;"></h3>
                <p class="kome" style="margin: 0.5em 0 0 0;"><small style="font-size:0.8rem;">音声:NHKクリエイティブ・ライブラリー</small></p>
            </div>
