  ...
  const QUIZ_DB = [
    ...
    },
    {
      poemNum: 17, poet: "在原業平", quizzes: [
        ...
        { q: "在原業平は、『伊勢物語』で、のちに天皇の后となる女性を盗み出した男として描かれている。", answer: true, explain: "史実として確認されているわけではありませんが、在原業平を主人公とした『伊勢物語』では、業平が、のちに清和天皇の后となる藤原<ruby>高子<rt>たかいこ</rt></ruby>を盗み出した（連れ出した）場面が描かれています。" },
      ]
    },
    {
    ...
    },
    {
      poemNum: 57, poet: "紫式部", quizzes: [
        ...
        { q: "紫式部は、宮中で出仕し始めた頃から「紫式部」という名前で呼ばれていた。", answer: false, explain: "紫式部は、宮中で中宮・彰子に仕えていた頃「<ruby>藤式部<rt>とうのしきぶ</rt></ruby>」と呼ばれていました。「紫式部」という呼び名は、のちに『源氏物語』の登場人物である紫の上にちなんで広まったと考えられています。" },
